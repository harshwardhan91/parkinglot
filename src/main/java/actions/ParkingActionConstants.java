...
public class ParkingActionConstants {
    ...
    public static final String REGISTRATION_NUMBERS_WITH_COLOUR = "registration_numbers_for_cars_with_colour";
    public static final String SLOT_NUMBERS_WITH_COLOUR= "slot_numbers_for_cars_with_colour";
